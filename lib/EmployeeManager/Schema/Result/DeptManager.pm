use utf8;
package EmployeeManager::Schema::Result::DeptManager;
...
=head1 TABLE: C<dept_manager>

=cut

__PACKAGE__->table("dept_manager");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:sUjWMpBiRXIIDA1hRt0uCg
